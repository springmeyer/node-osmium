...
/*
 ...
 Reads OSM file and outputs public transport lines into spatialite file.
 Public transport is often tagged differently in different places, this
 one works in Berlin, Germany.

 Call as:

 node berlin_public_transport.js OSMFILE DBFILE
